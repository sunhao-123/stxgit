  ...
  <div>
    ...
    >
      <el-upload
        ...
        action="https://www.sun0623.top/upload/avatar"
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="ifShowCrop = true" :disabled="cutDisable">裁 剪</el-button>
        <el-button type="primary" @click="handleOK" :disabled="cutDisable">确 定</el-button>
      </span>
    </el-dialog>
    <Cropper :dialogVisible="ifShowCrop" :cropOption="cropOption" @handleClose="closeCrop" @getCropImg="getCropImg(arguments)" @handleOK="CropImg" :originImg="slide2.oriUrl" :previewImg="slide2.preUrl"></Cropper>
  </div>
</template>
